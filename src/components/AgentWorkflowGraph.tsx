...
const initialEdges: Edge[] = [
  ...
  },
  {
    ...
    target: 'coordinator',
    label: 'summary',
    style: { stroke: 'hsl(var(--accent-foreground))', strokeDasharray: '5,5' },
    markerEnd: { type: MarkerType.ArrowClosed, color: 'hsl(var(--accent-foreground))' },
  },
  {
